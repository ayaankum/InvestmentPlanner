...
if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT * FROM user_login WHERE username='$uName' AND password='$pass'";
    $res = $conn->query($sql);

    if (mysqli_num_rows($res) == 1) {
        $user = mysqli_fetch_assoc($res);
        $id = $user['user_id'];
        $sq = "UPDATE user_login SET last_login_time=current_timestamp() WHERE user_id='$id'";
        $conn->query($sq);
            ...
            <div class="content">
                ...
                <div class="forms">
                    ...
                    <div class="pass-input">
                        <input name="pass" type="password" class="login-input" placeholder="Password" id="my-pass" required>
                ...
                <p class="new-account"><a>Not a user?</a> <a href="register.php">Sign Up now!</a></p>
                <br>
            </div>
        </div>
    </form>
